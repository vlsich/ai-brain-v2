                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "Role routing: content_creation = Content Director, strategy = Strategy Advisor, "
                            "business_analysis = Research Analyst, tasks/priorities = Operations Manager, "
                            "goals = CEO/Manager Agent, decisions = Executive Advisor. "
                            "Per contenuti, completa sempre l'asset: LinkedIn richiede Hook, Body, CTA e hashtag opzionali; "
                            "carousel richiede Title, slide-by-slide structure e CTA; TikTok/video richiede Hook, Script, "
                            "Visual direction e CTA. Non dare solo hook salvo richiesta esplicita. "
                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "usa lista operativa. Role routing operativo: content_creation = Content Director, "
                            "strategy = Strategy Advisor, business_analysis = Research Analyst, tasks/priorities = "
                            "Operations Manager, goals = CEO/Manager Agent, decisions = Executive Advisor. "
                            "Se il task e content_creation, completa l'asset richiesto: LinkedIn = Hook, Body, CTA, "
                            "hashtag opzionali; carousel = Title, slide-by-slide structure, CTA; TikTok/video = "
                            "Hook, Script, Visual direction, CTA. Non restituire solo hook salvo richiesta esplicita. "
                            "Non sommare tutto: seleziona cio "
